...
public enum RegressionUtil {
	 ...
	 * @param file            log file
	 */
	public static RampResult fitRampData(final List <Double> timeSamples, final List <Double> positionSamples, final List <Double> powerSamples, final boolean fitStatic, @Nullable final File file) {
		if (null != file) {
	 ...
	 * @param file            log file
	 */
	public static AccelResult fitAccelData(final List <Double> timeSamples, final List <Double> positionSamples, final List <Double> powerSamples, final RampResult rampResult, @Nullable final File file) {
		if (null != file) {
			try (final PrintWriter pw = new PrintWriter(file)) {
				pw.println("time,position,power");
				for (int i = 0 ; i < timeSamples.size() ; i++) {
