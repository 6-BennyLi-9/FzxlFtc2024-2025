...
public class ConceptGamepadRumble extends LinearOpMode {
	final ElapsedTime runtime = new ElapsedTime();    // Use to determine when end game is starting.
	...
	public void runOpMode() {
		...
		customRumbleEffect = new Gamepad.RumbleEffect.Builder().addStep(0.0, 1.0, 500)  //  Rumble right motor 100% for 500 mSec
